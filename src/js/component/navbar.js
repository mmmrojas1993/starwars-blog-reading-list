      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <div className="dropdown">
            <a
              className="nav-link dropdown-toggle text-secondary bg-transparent"
              href="#"
              id="navbarDropdown"
              role="button"
            ...
            <ul
              className="dropdown-menu text-secondary"
              aria-labelledby="navbarDropdown"
            >
              {store.favorites.map((value, key) => (
                <li>
                  <a key={key} className="dropdown-item" href="#/action-4">
                    {value}{" "}
                    <i
                      onClick={() => actions.deletefavorites(key)}

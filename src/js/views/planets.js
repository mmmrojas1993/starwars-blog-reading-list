...
import Planetsbg from "../../img/starwars-banner-planets.jpg";
import Planetimg from "../../img/tatoine-planets.jpg";
    ...
    <div className="contenedor">
      ...
      <div className="container">
        {store.planets.map((value, i) => (
          <div
            key={i}
            className="card m-2 g-4 row flex-row bg-dark"
          ...
          >
            ...
            <div className="card-body">
              ...
              <div className="cardbuttons">
                <Link
                  className="btn btn-border border-danger ms-2 text-danger"
                  to={"planetsdetails/" + value.uid}
                >
                  Learn More!
                </Link>
                <button
